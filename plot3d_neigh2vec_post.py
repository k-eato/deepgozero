...
def main(data_root,ont, model):
    ...
    model_file = f'{data_root}/{ont}/deepgozero_n2vec.th'
    ...
    mf_embeds = mf_embeds[th.randint(len(mf_embeds), (600,))]
    cc_embeds = cc_embeds[th.randint(len(cc_embeds), (600,))]
    bp_embeds = bp_embeds[th.randint(len(bp_embeds), (600,))]
...
def plot_scatter(embeds, labels, model):
    ...
    plt.title('UMAP Projection of GO Embeddings - Neigh2vec PostTrain - BP',fontsize=12)
