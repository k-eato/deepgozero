...
def main(data_root,ont, model):
    ...
    model_file = f'../deepgozero/{ont}_deepgozero_native.th'
    ...
    mf_embeds = mf_embeds[th.randint(len(mf_embeds), (1000,))]
    cc_embeds = cc_embeds[th.randint(len(cc_embeds), (1000,))]
    bp_embeds = bp_embeds[th.randint(len(bp_embeds), (1000,))]
...
def plot_scatter(embeds, labels, model):
    ...
    plt.title('UMAP Projection of GO Embeddings - El Embed PreTrain - CC ',fontsize=12)
